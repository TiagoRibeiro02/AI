...
def eval_positions(board, player):
    ...
    if player == 0:
        ...
        wpawns = wpawn1+ wpawn2+ wpawn3 + wpawn4 + wpawn5 + wpawn6 + wpawn7 + wpawn8
...
def f_obj(board, play):
    ...
    w = 'abcdedghijklmnop'
    b = 'ABCDEFGHIJKLMNOP'
    pts = [50, 30, 30, 900, 999999999, 30, 30, 50, 10, 10, 10, 10, 10, 10, 10, 10]
    score_w = 0
    score_w_positions = 0
    ...
    val_ameaca = len(ameaca_ativa(board, 'a', play)) + (len(ameaca_ativa(board, 'e', play)) * 999999) + len(ameaca_ativa(board, 'b', play)) + len(ameaca_ativa(board, 'c', play)) + (len(ameaca_ativa(board, 'd', play) *100))
